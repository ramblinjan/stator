...
describe("deparam module", () => {
  ...
  it('should convert root primitives other than strings', () => {
    const queryString = '?num=1&bool=true&implicitUndef&explicitUndef=undefined&nullVal=null';
    const expected = {
      num: 1,
      bool: true,
      implicitUndef: undefined,
  ...
  it('should handle nested arrays', () => {
    ...
    const expected = {
      myRoot: 'root',
      myArr: [1, [undefined, [[{bool: true}]]]]
    };
    const actual = deparam(expected);
    expect(actual).toEqual(expected);
  });
